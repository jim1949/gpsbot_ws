...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/relaybot/gpsbot_ws/src/ros_arduino_bridge/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/relaybot/gpsbot_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/relaybot/gpsbot_ws/install)
...
if(NOT "/home/relaybot/gpsbot_ws/src/ros_arduino_bridge/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/relaybot/gpsbot_ws/src/ros_arduino_bridge/openslam_gmapping/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws/src/ros_arduino_bridge/openslam_gmapping/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
