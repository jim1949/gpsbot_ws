...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/relaybot/gpsbot_ws/src/navigation/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /home/relaybot/gpsbot_ws/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /home/relaybot/gpsbot_ws/install)
...
if(NOT "/home/relaybot/gpsbot_ws/devel/include;/home/relaybot/gpsbot_ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-5.8 " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/relaybot/gpsbot_ws/devel/include;/home/relaybot/gpsbot_ws/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-5.8")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws/src/navigation/costmap_2d/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/relaybot/gpsbot_ws/devel/lib;/home/relaybot/api_ws/devel/lib;/home/relaybot/catkin_ws/devel/lib;/opt/ros/indigo/lib)
