...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /home/relaybot/gpsbot_ws/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /home/relaybot/gpsbot_ws/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /home/relaybot/gpsbot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws/src/urdf_tutorial/${idir}'.  Ask the maintainer 'jimmy <jimmy@todo.todo>' to fix it.")
    endif()
