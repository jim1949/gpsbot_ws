...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/relaybot/gpsbot_ws/src/navigation/amcl)
  set(amcl_DEVEL_PREFIX /home/relaybot/gpsbot_ws/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/relaybot/gpsbot_ws/install)
...
if(NOT "/home/relaybot/gpsbot_ws/devel/include;/home/relaybot/gpsbot_ws/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/relaybot/gpsbot_ws/devel/include;/home/relaybot/gpsbot_ws/src/navigation/amcl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws/src/navigation/amcl/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
