...
if("TRUE" STREQUAL "TRUE")
  set(move_base_msgs_SOURCE_PREFIX /home/relaybot/gpsbot_ws/src/navigation/move_base_msgs)
  set(move_base_msgs_DEVEL_PREFIX /home/relaybot/gpsbot_ws/devel)
  ...
  set(move_base_msgs_INSTALL_PREFIX /home/relaybot/gpsbot_ws/install)
...
if(NOT "/home/relaybot/gpsbot_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws/src/navigation/move_base_msgs/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
