...
if("TRUE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /home/relaybot/gpsbot_ws/src/rosauth)
  set(rosauth_DEVEL_PREFIX /home/relaybot/gpsbot_ws/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /home/relaybot/gpsbot_ws/install)
...
if(NOT "/home/relaybot/gpsbot_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws/src/rosauth/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>' to fix it.")
    endif()
