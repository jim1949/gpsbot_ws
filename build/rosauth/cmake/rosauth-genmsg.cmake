...
get_filename_component(_filename "/home/relaybot/gpsbot_ws/src/rosauth/srv/Authentication.srv" NAME_WE)
add_custom_target(_rosauth_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosauth" "/home/relaybot/gpsbot_ws/src/rosauth/srv/Authentication.srv" ""
)
...
_generate_srv_cpp(rosauth
  "/home/relaybot/gpsbot_ws/src/rosauth/srv/Authentication.srv"
  "${MSG_I_FLAGS}"
  ""
