...
echo_and_run cd "/home/relaybot/gpsbot_ws/src/rbx1/rbx1_vision"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/relaybot/gpsbot_ws/src/rbx1/rbx1_vision/setup.py" \
    build --build-base "/home/relaybot/gpsbot_ws/build/rbx1/rbx1_vision" \
    install \
    $DESTDIR_ARG \
