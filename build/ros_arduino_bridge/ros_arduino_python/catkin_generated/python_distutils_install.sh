...
echo_and_run cd "/home/relaybot/gpsbot_ws/src/ros_arduino_bridge/ros_arduino_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/relaybot/gpsbot_ws/src/ros_arduino_bridge/ros_arduino_python/setup.py" \
    build --build-base "/home/relaybot/gpsbot_ws/build/ros_arduino_bridge/ros_arduino_python" \
    install \
    $DESTDIR_ARG \
