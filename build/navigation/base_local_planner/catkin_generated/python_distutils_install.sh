...
echo_and_run cd "/home/relaybot/gpsbot_ws/src/navigation/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/relaybot/gpsbot_ws/src/navigation/base_local_planner/setup.py" \
    build --build-base "/home/relaybot/gpsbot_ws/build/navigation/base_local_planner" \
    install \
    $DESTDIR_ARG \
